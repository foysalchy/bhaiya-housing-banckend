...
<style>
    * { box-sizing: border-box !important; }
    body, html { overflow-x: hidden !important; margin: 0 !important; padding: 0 !important; }
</style>
...
<script>
    // Header এর actual height dynamically set করবে
...
<div class="absolute inset-0 z-0 flex">
    <!-- Mobile তে hide, Desktop এ show -->
    <div class="hidden md:block md:w-1/2 bg-white"></div>
    
    <!-- সবসময় full width, Desktop এ half width -->
    <div class="w-full md:w-1/2 relative bg-white">
        ...
        <div class="relative w-full px-4 sm:px-6 md:pr-[8%] md:pl-0">
            ...
            <!-- Mission & Vision Text -->
            <div class="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-10 relative z-30  mt-16 px-4 sm:px-[8%] md:pl-[8%] md:pr-[4%]">
    ...
    <section class="relative w-full py-16 md:py-20 bg-[#f9f9f9] overflow-hidden">
        ...
        <div class="container mx-auto px-4 sm:px-6 md:px-6 lg:px-20 mb-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 lg:gap-24 mb-12 md:mb-16 lg:mb-24">
                <div class="text-[#595959] text-sm md:text-lg leading-relaxed pl-16">
                    {{ $aboutBhaiya?->short ?? '' }}
                </div>
