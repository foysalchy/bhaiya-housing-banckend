...
@section('content')
    ...
    <main class="">
            ...
            <div class="relative w-full" style="padding-left:0; padding-right:8%;">
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-6">
                    ...
                    <div class="md:col-span-8 flex flex-col relative">
                        ...
                        <!-- Heading -->
                        <div class="mt-10 md:mt-14 md:ml-12" data-aos="fade-up" data-aos-duration="1000"
                            data-aos-delay="200">
                            <h2
                                class="text-3xl md:text-5xl lg:text-7xl font-serif text-[#595959] leading-snug tracking-tight">
                                {!! $missionVision->title ?? '' !!}
                            </h2>
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-16 md:gap-10 relative z-30"
                    ...
                    <div class="md:col-span-6 relative" data-aos="fade-right">
                        <h2
                            class="font-serif italic text-[3rem] md:text-[4rem] lg:text-[6rem] leading-none text-[#1520187D] absolute -top-20 -left-6 z-0 opacity-40">
        ...
        <section id="timeline-section"
            class="relative w-full min-h-screen flex flex-col justify-between overflow-hidden bg-zinc-950 text-white py-16 px-6 md:px-20 lg:px-32">
            ...
            <div class="relative z-10 w-full" data-aos="fade-down">
                ...
                <h2
                    class="text-6xl md:text-[120px] lg:text-[153px] font-semibold tracking-tight leading-none text-[#f6f6f6] opacity-90">
            ...
            <div class="relative z-10 flex flex-col md:flex-row items-center justify-center mt-10">
                ...
                <div class="relative flex items-center">
                    <div class="relative z-10" data-aos="zoom-in" data-aos-duration="1200">
                        <div
                            class="w-[280px] h-[350px] md:w-[400px] md:h-[500px] overflow-hidden transform -rotate-6 shadow-2xl border-4 border-zinc-800 bg-zinc-900">
                            <img id="timeline-img"
                ...
                <!-- Description -->
                <div id="content-wrap"
                    class="relative z-30 mt-12 md:mt-40 md:ml-40 lg:ml-60 max-w-lg transition-all duration-500">
        ...
        <section class="relative w-full py-20 md:py-32 bg-[#05100a] text-white overflow-hidden">
            ...
            <div class="absolute inset-0 z-0  pointer-events-none">
                <img src="{{ asset($leadersMessage?->img_path ?? 'Message from leaders') }}" alt="leader"
                    class="w-full h-full object-cover">
            </div>
        ...
        <section class="relative w-full py-20 bg-[#f9f9f9] overflow-hidden">
            ...
            <div class="relative w-full overflow-visible">
                ...
                @if ($groupOverflowImg)
                    <div class="absolute top-[-8%] left-[6%] z-20" data-aos="fade-down" data-aos-duration="1200"
