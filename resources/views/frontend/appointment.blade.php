...
<section aria-label="Get In Touch Hero">
    <div class="relative flex items-center justify-start border-b-2 gradient-x-border overflow-hidden transition-all duration-[3000ms] ease-in-out h-[300px] md:h-[400px]">
        ...
        <div class="relative text-white px-4">
            ...
            <p class="text-sm md:text-xl transition-all delay-200 duration-[4000ms] opacity-100">Connect with us for support and investment inquiries</p>
        </div>
    </div>
</section>
    ...
    <div class="container mx-auto px-4 lg:py-32 py-20">
        <div class="flex md:flex-row flex-col lg:gap-20 gap-6 lg:pb-32 pb-20">
            <div class="basis-1/2">
                ...
                <p class="lg:text-xl text-slate-600 mb-6">Connect with Right Aid Hospital to explore lucrative investment opportunities and receive dedicated support for your financial growth today.</p>
            </div>
            <div class="basis-1/2">
                        ...
                        @if($setting && $setting->extra)
                            <div>
                                ...
                                <a href="tel:{{ preg_replace('/[^0-9+]/', '', $setting->extra) }}"
                                    class="text-slate-600 hover:text-brand-primary transition-colors duration-300">
                                    {{ $setting->extra }}
                                </a>
                            </div>
                        @endif
    ...
    <div class="container mx-auto px-4 lg:py-32 md:py-20 max-md:pb-20">
        <div class="flex items-center md:flex-row flex-col lg:gap-20 md:gap-0 gap-10 overflow-hidden">
            ...
            <div class="basis-1/2 lg:text-center">
                ...
                <p class="lg:text-xl text-slate-600 mb-8">Planning something extraordinary? Share a few details — we'll handle the rest with quiet precision.</p>
                <div class="w-fit lg:mx-auto">
                    <a href="{{ route('invest') }}"
                        ...
                        <span class="text-[16px] leading-[14px] text-white whitespace-nowrap transition-all duration-500 z-10
            ...
            <div class="basis-1/2">
                ...
                @if($errors->any())
                    <div role="alert" class="mb-4 p-4 bg-red-100 border border-red-400 text-red-800 rounded-xl text-sm">
                ...
                <form action="{{ route('getintouch.store') }}" method="POST"
                    ...
                    {{-- Interest Radio --}}
                    <fieldset class="mb-4">
                        <legend class="block text-slate-800 mb-3">
                    ...
                    <div class="mb-4">
                        <label for="contact_privacy" class="flex items-start gap-2 cursor-pointer w-fit">
                            <input id="contact_privacy" type="checkbox" name="privacy_agreed"
                                value="1" required aria-required="true" class="mt-1">
                            <span class="text-slate-600">I understand that Right Aid Hospital will securely hold my data in accordance with their
